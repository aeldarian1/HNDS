...
export default function AktivnostiPage() {
  ...
  const filters = [
    { value: 'all', label: t("pages.activities.filters.all") },
    { value: 'courses', label: t("pages.activities.filters.courses") },
    { value: 'events', label: t("pages.activities.filters.events") },
    { value: 'excursions', label: t("pages.activities.filters.excursions") },
    { value: 'social', label: t("pages.activities.filters.social") },
    { value: 'cultural', label: t("pages.activities.filters.cultural") },
  ];
